...
<section class="page-section">
	<div class="container">
		<img class="mb-5" src="client/img/about.jpg" alt="">
	...
	<!-- Review section -->
	<section class="review-section set-bg" data-setbg="client/img/review-bg.jpg">
		<div class="container">
			<div class="review-slider owl-carousel">
				<div class="review-item text-white">
					...
					<div class="clint-pic set-bg" data-setbg="client/img/review/1.jpg"></div>
				</div>
				<div class="review-item text-white">
					<div class="rating">
						<i class="fa fa-star"></i>
